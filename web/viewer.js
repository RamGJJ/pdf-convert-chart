...
function getViewerConfiguration() {
  return {
    ...
    sidebar: {
      ...
      toggleButton2: document.getElementById('sidebarToggle2'),
      

      thumbnailButton: document.getElementById('viewThumbnail'),
      thumbnailButton2: document.getElementById('viewThumbnail2'),
      outlineButton: document.getElementById('viewOutline'),
      outlineButton2: document.getElementById('viewOutline2'),
...
function webViewerInitialized() {
  ...
  appConfig.sidebar.toggleButton2.addEventListener('click', function () {
    PDFViewerApplication.pdfSidebar.toggle();
  });
...
var PDFSidebar = function () {
  function PDFSidebar(options, eventBus) {
    ...
    this.toggleButton2 = options.toggleButton;
    this.thumbnailButton = options.thumbnailButton;
    this.thumbnailButton2 = options.thumbnailButton2;

    this.outlineButton = options.outlineButton;
    this.outlineButton2 = options.outlineButton2;
  ...
  _createClass(PDFSidebar, [{
    ...
    value: function reset() {
      ...
      this.outlineButton2.disabled = false;
    ...
    value: function switchView(view) {
      ...
      switch (view) {
        case SidebarView.THUMBS:
          ...
          this.thumbnailButton2.classList.add('toggled');

          this.outlineButton.classList.remove('toggled');
          this.outlineButton2.classList.remove('toggled');
        ...
        case SidebarView.OUTLINE:
          ...
          if (this.outlineButton2.disabled) {
            return;
          }

          this.thumbnailButton.classList.remove('toggled');
          this.thumbnailButton2.classList.remove('toggled');

          this.outlineButton.classList.add('toggled');
          this.outlineButton2.classList.add('toggled');
    ...
    value: function _addEventListeners() {
      ...
      this.thumbnailButton2.addEventListener('click', function () {
        _this3.switchView(SidebarView.THUMBS);
      });
      this.outlineButton.addEventListener('click', function () {
        _this3.switchView(SidebarView.OUTLINE);
      });
      this.outlineButton2.addEventListener('click', function () {
        _this3.switchView(SidebarView.OUTLINE);
      });
      this.outlineButton.addEventListener('dblclick', function () {
        _this3.eventBus.dispatch('toggleoutlinetree', { source: _this3 });
      });
      this.outlineButton2.addEventListener('dblclick', function () {
        _this3.eventBus.dispatch('toggleoutlinetree', { source: _this3 });
      });
